                          ...
                          <div className="text-right space-y-1">
                            <Tooltip>
                              ...
                              <TooltipContent side="left" className="max-w-xs">
                                <p className="text-xs">
                                  <strong>Impact estimé</strong> – Quelle proportion du cycle est réellement du travail actif plutôt que du temps d’attente ? Amélioration attendue sur la métrique si le levier est appliqué. Basé sur l'analyse des données actuelles.
                                </p>
                              </TooltipContent>
                            </Tooltip>
                            <Tooltip>
