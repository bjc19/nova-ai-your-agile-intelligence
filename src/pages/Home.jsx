...
const translations = {
  en: {
    ...
    novaUnderstandsNuances: "Nova understands the nuances of your team daily routine and provides intelligent insights.",
  ...
  fr: {
    ...
    heroSubtitle: "Synchronisation multi-sources, gestion intelligente des risques, détection adaptative du mode projet, recommandations personnalisées, anonymisation intelligente sans rétention — création de valeur mesurable dans chaque sprint.",
