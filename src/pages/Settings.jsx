...
export default function Settings() {
  ...
  const handleTeamsConnect = async () => {
    try {
      ...
      // Open popup directly to teamsOAuthStart (which will redirect to Microsoft)
      const origin = window.location.origin;
      const popup = window.open(`${origin}/api/functions/teamsOAuthStart`, 'Teams OAuth', 'width=600,height=700');
